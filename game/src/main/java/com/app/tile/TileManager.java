...
public class TileManager {
    ...
    public TileManager(GamePanel gp){
        ...
        getTileImage();
        loadMap("/res/maps/mainRoom.txt", 0);
        loadMap("/res/maps/mainHouseFirstFloor.txt", 1);
        loadMap("/res/maps/mainboard.txt", 2);
        loadMap("/res/maps/laboratory.txt", 3);
        loadMap("/res/maps/forestMap.txt", 4);
        loadMap("/res/maps/laboratorySecondFloor.txt", 5);
        loadMap("/res/maps/combatZone.txt", 6);
        loadMap("/res/maps/trainingMap.txt", 7);
        loadMap("/res/maps/datoLana.txt", 8);
        loadMap("/res/maps/dataCenter.txt", 9);
        loadMap("/res/maps/datalonaFirstRoom.txt", 10);
        loadMap("/res/maps/datalonaSecondRoom.txt", 11);
    }
        ...
        try{
            ...
            while(tilePos <= 1074){
                ...
                if(tilePos<=1074){
                    ...
                    tile[tilePos].image = ImageIO.read(getClass().getResourceAsStream("/res/tiles/mainBoard/"+tileMenos+".png"));
            ...
            while(tilePos <= 1293){
                tileMenos = tilePos - 1;
                tile[tilePos] = new Tile();
                tile[tilePos].image = ImageIO.read(getClass().getResourceAsStream("/res/tiles/insideboard/tile"+tileMenos+".png"));
                tile[tilePos].collision = true;
